...
function useConnect(options) {
    ...
    const cancelConnection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        setIsConnecting(false);
        setConnectionStatus("disconnected");
    }, [
        setConnectionStatus
...
function useChainExplorers(chain) {
    ...
    const toChain = chainQuery.data ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["convertApiChainToChain"])(chainQuery.data) : undefined;
    return {
...
function useWalletImage(id) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const { getInstalledWalletProviders } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/wallets/injected/mipdStore.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
...
"[project]/node_modules/thirdweb/dist/esm/react/core/errors/mapBridgeError.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/useBridgeError.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useBridgeError(params) {
    ...
    let apiError;
    if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$types$2f$Errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]) {
        apiError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$core$2f$errors$2f$mapBridgeError$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mapBridgeError"])(error);
    } else {
        // Create ApiError from generic Error
        apiError = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$types$2f$Errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]({
            code: "UNKNOWN_ERROR",
    ...
    return {
        ...
        isClientError,
        isRetryable: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$core$2f$errors$2f$mapBridgeError$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isRetryable"])(apiError.code),
        isServerError,
...
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/useTransactionDetails.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useTransactionDetails({ transaction, client, wallet }) {
    const chainMetadata = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$core$2f$hooks$2f$others$2f$useChainQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useChainMetadata"])(transaction.chain);
    const hasSponsoredTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$wallets$2f$smart$2f$is$2d$smart$2d$wallet$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hasSponsoredTransactionsEnabled"])(wallet);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const [contractMetadata, value, erc20Value, transactionData] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$contract$2f$actions$2f$get$2d$compiler$2d$metadata$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCompilerMetadata"])(contract).catch(()=>null),
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$encode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["encode"])(transaction).catch(()=>"0x")
            ]);
            const [tokenInfo, gasCostWei] = await Promise.all([
                ...
                hasSponsoredTransactions ? 0n : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTransactionGasCost"])(transaction).catch(()=>null)
            ]);
            ...
            if (contractMetadata?.abi && transactionData.length >= 10) {
                try {
                    ...
                    const matchingFunction = functions.find((fn)=>{
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$node_modules$2f$viem$2f$_esm$2f$utils$2f$hash$2f$toFunctionSelector$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toFunctionSelector"])(fn) === selector;
                    });
                    if (matchingFunction) {
                        functionInfo = {
                            description: undefined,
            ...
            const resolveDecimals = async ()=>{
                ...
                if (erc20Value) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$extensions$2f$erc20$2f$read$2f$decimals$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["decimals"])({
            ...
            const totalCostWei = erc20Value && erc20Value.tokenAddress.toLowerCase() !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$constants$2f$addresses$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NATIVE_TOKEN_ADDRESS"] ? erc20Value.amountWei : (value || 0n) + (gasCostWei || 0n);
            const totalCost = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toTokens"])(totalCostWei, decimal);
            return {
                contractMetadata,
                costWei,
                functionInfo,
                gasCostDisplay: gasCostWei ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$web$2f$ui$2f$ConnectWallet$2f$screens$2f$formatTokenBalance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatTokenAmount"])(gasCostWei, 18)} ${nativeTokenSymbol}` : null,
                gasCostWei,
                tokenInfo,
                totalCost,
                totalCostWei,
                txCostDisplay: `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$web$2f$ui$2f$ConnectWallet$2f$screens$2f$formatTokenBalance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatTokenAmount"])(costWei, decimal)} ${tokenSymbol}`
            };
        },
        queryKey: [
            "transaction-details",
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stringify"])(transaction),
            hasSponsoredTransactions
        ]
    });
} //# sourceMappingURL=useTransactionDetails.js.map
}),
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/usePaymentMethods.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function usePaymentMethods(options) {
    ...
    const localWallet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$core$2f$hooks$2f$wallets$2f$useActiveWallet$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useActiveWallet"])(); // TODO (bridge): get all connected wallets
    ...
    const query = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            ...
            const url = new URL(`${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$domains$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getThirdwebBaseUrl"])("bridge")}/v1/buy/quote/${account.address}`);
            ...
            url.searchParams.set("amount", (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUnits"])(destinationAmount, destinationToken.decimals).toString());
...
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/pay/useBuyWithFiatQuotesForProviders.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useBuyWithFiatQuotesForProviders(params, queryOptions) {
    ...
    const queries = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQueries"])({
        queries: providers.map((provider)=>({
                ...
                queryFn: async ()=>{
                    ...
                    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$pay$2f$convert$2f$get$2d$token$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getToken"])(params.client, params.tokenAddress, params.chainId);
                    const amountWei = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toUnits"])(params.amount, token.decimals);
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Onramp$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prepare"])({
                        amount: amountWei,
...
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/useBridgePrepare.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@tanstack/react-query/build/modern/useQuery.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Buy$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Buy$3e$__ = __turbopack_context__.i("[project]/node_modules/thirdweb/dist/esm/bridge/Buy.js [app-ssr] (ecmascript) <export * as Buy>");
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: async ()=>{
            switch(type){
                case "buy":
                    {
                        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Buy$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Buy$3e$__["Buy"].prepare(prepareParams);
                        return {
                            type: "buy",
                            ...result
                        };
                ...
                case "sell":
                    {
                        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Sell$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Sell$3e$__["Sell"].prepare(prepareParams);
                        return {
                            type: "sell",
                            ...result
                        };
                ...
                case "transfer":
                    {
                        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Transfer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Transfer$3e$__["Transfer"].prepare(prepareParams);
                        return {
                            type: "transfer",
                            ...result
                        };
                ...
                case "onramp":
                    {
                        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$Onramp$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Onramp$3e$__["Onramp"].prepare(prepareParams);
                        return {
                            type: "onramp",
                            ...result
                        };
        ...
        queryKey: [
            "bridge-prepare",
            type,
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$json$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["stringify"])(prepareParams)
        ],
        retry: (failureCount, error)=>{
            // Handle both ApiError and generic Error instances
            if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$types$2f$Errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]) {
                const bridgeError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$react$2f$core$2f$errors$2f$mapBridgeError$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["mapBridgeError"])(error);
...
"[project]/node_modules/thirdweb/dist/esm/react/core/hooks/useStepExecutor.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function useStepExecutor(options) {
    ...
    const flatTxs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>preparedQuote?.steps ? flattenRouteSteps(preparedQuote.steps) : [], [
        preparedQuote?.steps
    ]);
    // State management
    const [currentTxIndex, setCurrentTxIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(undefined);
    const [executionState, setExecutionState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])("idle");
    ...
    const [completedTxs, setCompletedTxs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(new Set());
    const [onrampStatus, setOnrampStatus] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(preparedQuote?.type === "onramp" ? "pending" : undefined);
    ...
    const poller = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (pollFn, abortSignal)=>{
    ...
    const executeSingleTx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (tx, account, completedStatusResults, abortSignal)=>{
        if (typeof preparedQuote?.type === "undefined") {
            throw new Error("No quote generated. This is unexpected.");
        }
        const { prepareTransaction } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/transaction/prepare-transaction.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        const { sendTransaction } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/transaction/actions/send-transaction.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        ...
        if (tx.action === "approval" || tx.action === "fee") {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$wait$2d$for$2d$tx$2d$receipt$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["waitForReceipt"])(result);
            await new Promise((resolve)=>setTimeout(resolve, 2000)); // Add an extra 2 second delay for RPC to catch up to new state
            return;
        }
        // Poll for completion
        const { status } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/bridge/Status.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        await poller(async ()=>{
    ...
    const executeBatch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (txs, account, completedStatusResults, abortSignal)=>{
        if (typeof preparedQuote?.type === "undefined") {
            throw new Error("No quote generated. This is unexpected.");
        }
        ...
        const { prepareTransaction } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/transaction/prepare-transaction.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        const { sendBatchTransaction } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/transaction/actions/send-batch-transaction.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
    ...
    // Execute onramp step
    const executeOnramp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (onrampQuote, completedStatusResults, abortSignal)=>{
        setOnrampStatus("executing");
        // Open the payment URL
        windowAdapter.open(onrampQuote.link);
        // Poll for completion using the session ID
        const { Onramp } = await __turbopack_context__.r("[project]/node_modules/thirdweb/dist/esm/bridge/index.js [app-ssr] (ecmascript, async loader)")(__turbopack_context__.i);
        await poller(async ()=>{
    ...
    const execute = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        ...
        try {
            ...
            if (flatTxs.length > 0) {
                ...
                for(let i = startIndex; i < flatTxs.length; i++){
                    ...
                    if (currentTx.chainId !== wallet.getChain()?.id) {
                        await wallet.switchChain((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$chains$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getCachedChain"])(currentTx.chainId));
                    }
            ...
            if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$types$2f$Errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]) {
                setError(err);
            } else {
                setError(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$bridge$2f$types$2f$Errors$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"]({
                    code: "UNKNOWN_ERROR",
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
        async mutationFn (option) {
            ...
            if (!tokenAddress) {
                ...
                const gasEstimate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$estimate$2d$gas$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["estimateGas"])({
                    account,
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$utils$2f$units$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toWei"])(amount) + gasEstimate > balance.value) {
                    throw new Error("Insufficient balance for transfer amount and gas");
                }
                return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$thirdweb$2f$dist$2f$esm$2f$transaction$2f$actions$2f$send$2d$transaction$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["sendTransaction"])({
                    account,
                    transaction: sendNativeTokenTx
                });
            } else {
...
//# sourceMappingURL=node_modules_thirdweb_dist_esm_react_core_2c015eb0._.js.map